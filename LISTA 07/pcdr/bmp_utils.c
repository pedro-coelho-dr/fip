...
void bmp_write(char * filename, BMPFileHeader *file_header, BMPHeader *bmp_header, BMPData *data) {
    FILE *fp;
    ...
    fwrite(data, sizeof(BMPData), bmp_size, fp); // tamanho do BMPdata * bmp_size (200*200)
